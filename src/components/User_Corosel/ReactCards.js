...
export default class ReactCards extends React.Component {
    ...
    onzoom(card_name) {
        ...
        if (card_name == "disease") {
            ...
            dis[this.state.dis_tar].status == "open" ? st_color_class = "text-success" : st_color_class = "text-danger"
    ...
    render() {
        ...
        var card = (
            <div className="card text-dark shadow-lg bg-white mb-3" style={{ height: "600px", width: "1500px", marginTop: "250px", marginLeft: "150px" }}>
                <div className="card-header"><b>Disease</b></div>
        ...
        if (this.state.zoom_card_name == "disease") {
            card = (
                <div className="card text-dark shadow-lg bg-white mb-3" style={{ height: "600px", width: "1500px", marginTop: "250px", marginLeft: "150px" }}>
                    <div className="card-header"><b>Disease</b></div>
                    <div className="card-body">
                        <h3 className="card-title"><i>{dis[this.state.dis_tar].name}</i></h3>
                        <h5 className="card-title">Date Of Registration:-{dis[this.state.dis_tar].dateOfReg}</h5>
                        <h5 className={st_color_class}>{dis[this.state.dis_tar].status}</h5><br />
                        <h5 className="card-title">Reports</h5>
                        <ul>
                            {
                                dis[this.state.dis_tar].reports.map(dis_repo => <li className="card-text"><h6>{dis_repo}</h6></li>)
                            }
                        </ul>
                        <h6 className="card-text" style={{ fontSize: "17px" }}>{dis[this.state.dis_tar].desc}</h6>
            ...
            card = (
                <div className="card text-dark shadow-lg bg-white mb-3" style={{ height: "600px", width: "1500px", marginTop: "250px", marginLeft: "150px" }}>
                    <div className="card-header"><b>Diagnostics</b></div>
                    <div className="card-body">
                        {
                            dis[this.state.dis_tar].diagnosis.map(diag_data =>
                                <div>
                                    <h3 className="card-title">{diag_data.date}</h3><br />
                                    <h4 className="card-title">Symptoms</h4>
                                    <ul>
                                        {diag_data.vSymptoms.map(data_sym => <li className="card-text"><h5>{data_sym}</h5></li>)}
                                    </ul>
                                </div>
                            )}
                    </div>
            ...
            card = (
                <div className="card text-dark shadow-lg bg-white mb-3" style={{ height: "600px", width: "1500px", marginTop: "250px", marginLeft: "150px" }}>
                    <div className="card-header"><b>Treatment</b></div>
                    <div className="card-body">
                        <Grid>
                            <Grid item xs={6}>
        ...
        return (
            <>
                ...
                <Grid container ml={10} spacing={2}>
                    <Grid item xs={4}>
                        <TinderLikeCard
                            images={arr}
                            width="350"
                    ...
                    <Grid item xs={4}>
                        <div className="col-sm"><ReactCards2 swipee="swipeDown" dis2={dis[this.state.dis_tar]} rc2_swipp={this.state.RC2_swip} targett="diagno" /></div>
                    </Grid>
                    <Grid item xs={4}>
                        <div className="col-sm"><ReactCards2 swipee="swipeCornerDownRight" dis2={dis[this.state.dis_tar]} rc2_swipp={this.state.RC2_swip} targett="treatment" /></div>
                    </Grid>
                    <Grid item xs={4}>
                        <button className="btn btn-warning" style={{ marginTop: "230px", width: "68%" }} onClick={this.onzoom.bind(this, "disease")}>
                    ...
                    <Grid item xs={4}>
                        <button className="btn btn-warning" style={{ marginTop: "230px", width: "68%" }} onClick={this.onzoom.bind(this, "diagno")}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-chevron-double-down" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M1.646 6.646a.5.5 0 0 1 .708 0L8 12.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                <path fill-rule="evenodd" d="M1.646 2.646a.5.5 0 0 1 .708 0L8 8.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                            </svg>
                    ...
                    <Grid item xs={4}>
                        <button className="btn btn-warning" style={{ marginTop: "230px", width: "68%" }} onClick={this.onzoom.bind(this, "treatment")}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" class="bi bi-chevron-double-down" viewBox="0 0 16 16">
                                <path fill-rule="evenodd" d="M1.646 6.646a.5.5 0 0 1 .708 0L8 12.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                                <path fill-rule="evenodd" d="M1.646 2.646a.5.5 0 0 1 .708 0L8 8.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z" />
                            </svg>
                    ...
                    <Grid item xs={12}>
                        <button className="btn btn-danger" style={{ marginTop: "20px", width: "36%" }} onClick={this.onTinderSwipe.bind(this)}>
                ...
                >
                    <Zoom in={this.state.zooom} style={{ transitionDelay: this.state.zooom ? '200ms' : '0ms' }}>
                        {card}
                    </Zoom>
                </Modal>
